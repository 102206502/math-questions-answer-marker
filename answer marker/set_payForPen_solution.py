...
temp_step.addKey('(設|令).*買\s*(x|X)\s*(枝|支)鉛筆')
...
temp_step.addKey('(設|令).*買\s*(x|X)\s*(枝|支)原子筆')
temp_solution.add_step(temp_step)
...
temp_step.addKey('(設|令).*買\s*(x|X)\s*(枝|支)鉛筆')
temp_step.addKey('(設|令).*買\s*(y|Y)\s*(枝|支)原子筆')
temp_solution.add_step(temp_step)
...
temp_step.addKey('(設|令).*買\s*(x|X)\s*(枝|支)原子筆')
temp_step.addKey('(設|令).*買\s*(y|Y)\s*(枝|支)鉛筆')
temp_solution.add_step(temp_step)
